...
class TestCEL(BaseTest):
    def test_celfilter_vpc_get_sg_tags(self):
        session_factory = self.replay_flight_data("test_celfilter_vpc_get_sg_tags")

        p = self.load_policy(
            {
                "name": "vpc-related-sg-tags",
                "resource": "vpc",
                "filters": [
                    {
                        "type": "cel",
    ...
    def test_celfilter_vpc_get_subnet_tags(self):
        session_factory = self.replay_flight_data("test_celfilter_vpc_get_subnet_tags")

        p = self.load_policy(
            {
                "name": "vpc-related-subnet-tags",
                "resource": "vpc",
                "filters": [
                    {
                        "type": "cel",
    ...
    def test_cel_vpc_get_nat_gateway_tags(self):
        session_factory = self.replay_flight_data("test_cel_vpc_get_nat_gateway_tags")

        p = self.load_policy(
            {
                "name": "vpc-related-nat-gateway-tags",
                "resource": "vpc",
                "filters": [
                    {
                        "type": "cel",
    ...
    def test_cel_vpc_get_igw_tags(self):
        session_factory = self.replay_flight_data("test_cel_vpc_get_igw_tags")

        p = self.load_policy(
            {
                "name": "vpc-related-internet-gateway-tags",
                "resource": "vpc",
                "filters": [
                    {
                        "type": "cel",
