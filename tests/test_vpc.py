...
class TestCEL(BaseTest):
    def test_celfilter_vpc_get_sg_tags(self):
        session_factory = self.record_flight_data("test_celfilter_vpc_get_sg_tags")
        ...
        p = self.load_policy(
            {
                ...
                "filters": [
                    {
                        "type": "cel",
                        "expr": "map_keys_equal(get_related_sgs(Resource), \"TestTag\", \"TestValue\")"
                    },
                ],
            },
            session_factory=session_factory,
    ...
    def test_celfilter_vpc_get_subnet_tags(self):
        session_factory = self.record_flight_data("test_celfilter_vpc_get_subnet_tags")
        ...
        p = self.load_policy(
            {
                ...
                "filters": [
                    {
                        "type": "cel",
                        "expr": "map_keys_equal(get_related_subnets(Resource), \"TestTag\", \"TestValue\")"
                    },
                ],
            },
            session_factory=session_factory,
